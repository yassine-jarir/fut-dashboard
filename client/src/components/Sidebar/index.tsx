...
import logo from "@/../public/images/efoot (1).jpg"
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "/GestionDesJoueurs",
        children: [
                  { label: "Formulaire", route: "/" }  
...
const Sidebar = ({ sidebarOpen, setSidebarOpen, setIsJoinFormActive,setIsClubFormActive }: any) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-[14.125rem] flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/" className="flex justify-center mb-0 items-center">
            <Image
              width={176}
              height={32}
              src={logo}
              className=" rounded-[3rem] w-[53px]"
              alt="Logo"
              priority
            />
